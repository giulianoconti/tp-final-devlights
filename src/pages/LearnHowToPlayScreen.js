  ...
  return <>
    <div className="flex flex-col min-h-screen items-center justify-start bg-hunterGreen text-gray-100">
      <div className="max-w-5xl px-5">
        ...
        <h3 className="font-medium leading-tight text-3xl mt-0 mb-2 text-bittersweetShimmer">Reglas generales del juego</h3>
          <p className="text-base font-light leading-relaxed mt-0 mb-4 text-gray-800">
            ...
            Normalmente, se te otorgará un pago después de que la banca haya completado su mano. En todos los juegos de blackjack, la banca deberá conseguir ya sea una mano dura o blanda con un total de 16 o inferior.
          </p>
